...
public class MOEGMOnOffBtn : MonoBehaviour {
    ...
    void Start()
    {
        ...
        m_bOptionState = KDHManager.I.m_bEfectSoundState;
    ...
    void OnClick()
    {
        ...
        {
            m_Background.spriteName = "ON";
            KDHManager.I.m_bEfectSoundState = true;
        }
        else
        {
            m_Background.spriteName = "OFF";
            KDHManager.I.m_bEfectSoundState = false;
        }
    }
}
