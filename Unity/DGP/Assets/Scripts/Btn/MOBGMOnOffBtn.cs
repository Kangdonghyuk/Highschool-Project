...
public class MOBGMOnOffBtn : MonoBehaviour {
	...
	void Start () {
        ...
        m_bOptionState = KDHManager.I.m_bBGSoundState;
    ...
    void OnClick()
    {
        ...
        {
            m_Background.spriteName = "ON";
            KDHManager.I.m_bBGSoundState = true;
        }
        else
        {
            m_Background.spriteName = "OFF";
            KDHManager.I.m_bBGSoundState = false;
        }
    }
}
