...
public class TutorialItemMng : MonoBehaviour {

    private static TutorialItemMng m_Instance = null;
    public static TutorialItemMng I
    {
        get
        {
            if (null == m_Instance)
            {
                m_Instance = FindObjectOfType(typeof(TutorialItemMng)) as TutorialItemMng;
    ...
    public void ICardAllTurn()
    {
        ...
        {
            if (TutorialCardMng.I.m_bStartState == false && TutorialCardMng.I.m_bICardAllTurnState == false)
            {
                TutorialCardMng.I.ICardAllTurn();
    ...
    public void ICardRandomClear()
    {
        if (m_nCardRandomClearNum > 0)
        {
            ...
            {
                if (TutorialCardMng.I.m_bStartState == false && TutorialCardMng.I.m_bICardRandomClearState == false && TutorialCardMng.I.m_nCardLiveNum > 0)
                {
                    TutorialCardMng.I.ICardRandomClear();
