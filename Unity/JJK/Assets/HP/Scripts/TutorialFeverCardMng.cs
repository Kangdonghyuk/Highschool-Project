...
public class TutorialFeverCardMng : MonoBehaviour {

    private static TutorialFeverCardMng m_Instance = null;
    public static TutorialFeverCardMng I
    {
        get
        {
            if (null == m_Instance)
            {
                m_Instance = FindObjectOfType(typeof(TutorialFeverCardMng)) as TutorialFeverCardMng;
    ...
    void Update()
    {
        ...
        if (Tutorial.I.m_bFiver && Input.GetMouseButtonDown(0))
        {
            StartCoroutine("FeverCardAllTurn");
            Tutorial.I.m_bFiver = false;
        }
	}
